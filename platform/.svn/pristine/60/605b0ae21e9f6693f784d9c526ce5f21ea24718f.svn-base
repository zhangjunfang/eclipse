...
import cn.newcapec.framework.core.utils.fileUtils.fileloader.FileLoader;
import cn.newcapec.framework.core.utils.fileUtils.fileloader.FileLoaderFactory;
import cn.newcapec.framework.core.utils.fileUtils.fileloader.PathFileLoader;
import cn.newcapec.framework.core.utils.zipUtils.CZipEntry;
import cn.newcapec.framework.core.utils.zipUtils.CZipOutputStream;
...
public class IoUtil {
	...
	public static final void writeToFile(File file, String content) throws IOException {
		OutputStreamWriter writer = new OutputStreamWriter(new FileOutputStream(file), DEFAULT_CHAR_SET);
		writer.write(content);
		writer.close();
	}
	...
	public static final void writeToFile(OutputStream out, String content) throws IOException {
		OutputStreamWriter writer = new OutputStreamWriter(out, DEFAULT_CHAR_SET);
		writer.write(content);
		writer.close();
	}
	...
	public static byte[] readBytes(String filePath) throws IOException {
		InputStream in = null;
		try {
			FileLoader fileLoader = FileLoaderFactory.creatFileLoader(PathFileLoader.class, null);

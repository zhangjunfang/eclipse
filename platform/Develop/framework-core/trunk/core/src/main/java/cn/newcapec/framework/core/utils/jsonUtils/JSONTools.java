package cn.newcapec.framework.core.utils.jsonUtils;
...
public class JSONTools {
	 ...
	 * @author:zhanghongliang
	 *
	 * @param jsonData {@link net.sf.json.JSONObject}
	 * @param clazz	{@link Class}
	 * @param jsonConfig {@link net.sf.json.JsonConfig}
	 * @return
	 */
	 ...
	 * @author:zhanghongliang
	 *
	 * @param jsonData  {@link net.sf.json.JSONObject}json对象
	 * @param clazz     要转换的成的对象
	 * @param excludes  不包含的字段名称
	 * @param datePattern   日期的正则
	 * @param includeNull   是否包括null，空串字段
	 * @return
	 */
	 ...
	 * @author:zhanghongliang
	 *
	 * @param excludes  不包含的字段，哪些字段需要过滤掉
	 * @param datePattern  日期转换格式
	 * @param includeNull  是否包含值为null的字段，默认包含  true 包含，false不包含
	 * @return
	 */

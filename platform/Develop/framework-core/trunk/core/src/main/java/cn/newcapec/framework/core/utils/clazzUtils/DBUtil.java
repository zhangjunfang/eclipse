package cn.newcapec.framework.core.utils.clazzUtils;
...
import cn.newcapec.framework.core.utils.MathUtils.MathUtil;
...
public class DBUtil {
	...
	static DbEngineService iDbEngineService = SpringConext.getApplicationContext().getBean(DbEngineService.class);
	...
	public static List query(String querySQL, Object params, Class modelClass) throws BaseException {
		return iDbEngineService.query(querySQL.toString(), new Object[]{params}, modelClass,
				PageContext.getPagesize(), PageContext.getOffset());
	}
	
	public static List query(String querySQL, Class modelClass) throws BaseException {
		return iDbEngineService.query(querySQL.toString(), null, modelClass,
				PageContext.getPagesize(), PageContext.getOffset());
	}
	...
	public static PagingResultSet getPagingResultSet( String querySQL,Object param,  Class modelClass)throws BaseException {
		return getPagingResultSet(querySQL, new Object[] { param }, modelClass,
				PageContext.getPagesize(), PageContext.getOffset());
		
	}
	public static PagingResultSet getPagingResultSet(String querySQL,  Class modelClass)throws BaseException {

...
<link rel="stylesheet" type="text/css"
	...
	media="screen">
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>cdn/js/bootstrap-datetimepicker/2.2.0/css/bootstrap-datetimepicker.min.css"
	media="screen">
<style>
body {
	margin-top: 10px;
...
<body>
	...
	<script type="text/javascript"
		src="<%=basePath%>cdn/js/bootstrap-datetimepicker/2.2.0/js/bootstrap-datetimepicker.js"
		charset="UTF-8"></script>
	<script type="text/javascript"
		src="<%=basePath%>cdn/js/bootstrap-datetimepicker/2.2.0/js/locales/bootstrap-datetimepicker.zh-CN.js"
		charset="UTF-8"></script>
	<script type="text/javascript" src="<%=basePath%>static/js/addFrm.js"></script>
	<script type="text/javascript">

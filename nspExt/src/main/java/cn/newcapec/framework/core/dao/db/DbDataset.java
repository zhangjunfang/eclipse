...
import cn.newcapec.framework.core.utils.stringUtils.JsonUtil;
...
public class DbDataset implements Serializable {
	...
	public DbDataset(String sql, ParameterSet params, boolean supportPaging,
		...
		this(sql, params, supportPaging, cn.newcapec.framework.core.utils.MathUtils.MathUtil.getInteger(pageIndex)

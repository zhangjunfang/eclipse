...
import cn.newcapec.framework.core.exception.ExceptionUtil;
...
import cn.newcapec.framework.core.handler.UrlMapping;
	...
	private void callMethod() {
		try {
			...
			try {
				...
				// 获取参数
				BaseResponse baseResponse = new BaseResponseImpl(this
						.getResponse());

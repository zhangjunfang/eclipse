...
public class JsonUtil implements LogEnabled {
     ...
     * ..,{}]}
     *
     * @param jsonArray          转换为json对象的属性列表
     * @param possibleTotalCount 记录总数量
     * @return
     */
     ...
     * ]}
     *
     * @param list               javabena对象集合
     * @param names              转换为json对象的属性列表
     * @param possibleTotalCount 记录总数
     * @return
     */

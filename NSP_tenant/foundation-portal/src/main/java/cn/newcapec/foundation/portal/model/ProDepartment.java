 ...
 */
@Entity
@Table(name = "t_prodepartment")
public class ProDepartment  extends AppBaseModel implements Serializable {
	...
	public ProDepartment(){
		
	}
	
	public  ProDepartment(String parentId){

	...
	paging:function(pageView,gopageFunc){
		...
		result += "| 总记页数:" + pageView.totalpage +"页  ";
		 ...
		 if(pageView.currentpage != 1) {
			 result += '<a href="javascript:void(0)" onclick="'+gopageFunc + '('+1+')' +'" title="首页" class="nav"><span>首页&nbsp;</span></a>'; 
			result += '<a href="javascript:void(0)" onclick="'+gopageFunc + '('+(pageView.currentpage-1)+')' +'" title="上一页" class="nav"><span>上一页&nbsp;</span></a>'; 
		 }else  {
			result += '<span>首页&nbsp;</span>';
		 ...
		 if (pageView.currentpage != pageView.totalpage && pageView.totalpage> 0) {
			 result += '<a href="javascript:void(0)" onclick="'+gopageFunc + '('+(pageView.currentpage+1)+')' +'" title="下一页" class="nav"><span>下一页&nbsp;</span></a>'; 
		 	 result += '<a href="javascript:void(0)" onclick="'+gopageFunc + '('+pageView.totalpage+')' +'" title="末页" class="nav"><span>末页</span></a>'; 
		 } else {

...
public  class WebUtils  implements LogEnabled {
	 ...
	 * @return
	 */
	public static User getSessionLoginUser(Request  request) {
		User user = (User) HttpNewcapecContextFactory.getContext(WebUtils.getRequests(request)).getAttribute(5, Keys.USER);
		if(null!=user){
			return user;
		}
		return null;
   ...
   /**
	...
	/***
	 * 获取URI的路径,如路径为http://www.baidu.com/action/post.htm?method=add, 得到的值为"/action/post.htm"
	 *
	 * @param request
	 * @return
	 */
...
//		double num = Double.parseDouble(s);
	...
	public static void requestConvertPostUrlEncode(HttpServletRequest request, String FromCodeName, String ToCodeName, String qs)
	  {
	    String[] paramValues;
	    int i;
	    String paramName = "";
	    ...
	    while (true) { do { if (!(paramNames.hasMoreElements())) return;
	...
	public static void requestConvertEncode(HttpServletRequest request, String fromCodeName, String toCodeName)
	  ...
	  /**
	    ...
	    public static String getDynmicName(HttpServletRequest httpRequest){
	    	...
	    	String  dyName  = "http://"+httpRequest.getLocalName()+":"+httpRequest.getLocalPort()+httpRequest.getContextPath();
	    ...
	    public static String formatEmail(String  email){
	    	...
	    	if(null!=email&&!"".equals(email)){
	    		...
	    		return  sb.replace(sb.indexOf("@") - 2, sb.indexOf("@"), "**").toString();
	    	}
